...
\citet{Chatzis_Bors_Pitas_1999}'s study on human authentication is an example of a decision-level fusion due to its use of clustering methods that divide data into groups known as clusters.
