...
The models except XGBoost appear at least two times, which are Logistic Regression and SVM. Openness and Extraversion have Logistic Regression as the best model, while Conscientiousnes and Agreeable have SVM as the best model.
