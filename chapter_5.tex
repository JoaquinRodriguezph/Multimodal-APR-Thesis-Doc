...
For the Imagga object tags, we tested two approaches: using all detected tags regardless of confidence, and applying a 30\% confidence threshold to retain only tags the model identified with reasonable certainty. 
