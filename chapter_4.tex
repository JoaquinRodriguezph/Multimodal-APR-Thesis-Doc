...
However, for specific traits where initial modeling experiments with the full feature set yielded poor performance, exhibited significant signs of overfitting, or proved computationally prohibitive, Principal Component Analysis (PCA) was applied to the TF-IDF feature sets. In these instances, PCA was used to create a more compact and less noisy representation before feature fusion. This two-stage approach allowed the study to first prioritize interpretability while retaining a robust method for managing dimensionality where it was empirically shown to be necessary.
